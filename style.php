...
.fbp-cnt p, .fsp-cnt p{color: #000;
	...
	font-weight: 400;
    margin-bottom: 26px;
	line-height: 1.5;letter-spacing: 0.0px;word-break: break-word;}
...
.arch-tlt{margin:20px 0px 30px;display:inline-block;width:100%;margin-bottom: 20px;overflow: hidden;padding: 20px;
background-color: #6a6a6a;}
h1.page-title {font-size: 70px;font-size: 7rem;margin-bottom: 0;font-family: 'Playfair Display',serif;font-style: normal;text-align: center;color: #fff;padding: 0;}
...
if( is_page() || ampforwp_is_front_page() || ampforwp_polylang_front_page() ){?>
    <?php if(!checkAMPforPageBuilderStatus(get_the_ID())){ ?>
        ...
        .breadcrumbs {padding-bottom: 10px;border-bottom: 1px solid #765298;display: inline-block;width: 100%;font-size: 1.2rem;text-transform: uppercase;}
        #breadcrumbs li{list-style-type:none;}
        #breadcrumbs a {color: #765298;}
	...
	.amp-comments-wrapper ul li:hover .comment-meta .comment-metadata a{color:#765298;}
	.cmts .comment-metadata a{color: #765298;}
...
.amp-author-image amp-img {margin: 0px 0px 0px 12px;}
.prev {float: right;}
.next {float: left;}
.r-pf{direction:rtl;}
